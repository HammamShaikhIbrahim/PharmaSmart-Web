...
if ($role_id == 2) {
    ...
    if ($pharma_query && mysqli_num_rows($pharma_query) > 0) {
        ...
        if (!empty($pharma_data['Logo']) && $pharma_data['Logo'] != 'default.png') {
            ...
            // لو مش رافع لوجو، نعمله لوجو بالحروف الأولى من اسم الصيدلية بلون Emerald
            $avatar_url = "https://ui-avatars.com/api/?name=" . urlencode($pharma_data['PharmacyName']) . "&background=10b981&color=fff&bold=true";
        }
    }
}
?>
